...
Let $X$ be the proportion of correct responses on a test with 100 questions. $S_x = \{0.00,0.01,0.02,...,0.98, 0.99, 1.00\}$. The sample space is finite. Note that the elements of the sample space is not integers.
...
Let $X$ be the number of times you roll a die until you get a 6. $S_x = \{1,2,3,4,5,6,7,8,...\}$ The sample space is countably infinite.
:::
